<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerificationCode.aspx.cs" Inherits="EParking.VerificationCode" %>
	  ...
	  <div class="u-clearfix u-sheet u-valign-middle-sm u-sheet-1">
		...
		<div class="u-container-style u-group u-white u-group-1" style="left: 284px; top: 22px">
		  <div class="u-container-layout u-container-layout-1">
			<h2 class="u-align-center u-custom-font u-font-oswald u-text u-text-3">Check your email
			</h2><br /><br />
			 ...
			 <div class="u-form-vertical">
			  ...
			  <form action="#" method="POST" class="u-clearfix  u-inner-form" style="padding: 0;" source="custom" id="form2"  runat="server">
				...
				<div class="u-form-group u-form-group-4 u-form-spacing-30 u-form-vertical "><br />
				  <label for="text-47f9" class="u-label u-label-3">Enter the verification code you received in your email</label><br />
				  <asp:TextBox placeholder="5-digit code" ID="VCode" name="name1" class="u-border-1 u-border-grey-75 u-input u-input-rectangle u-white" required runat="server" ></asp:TextBox>
				  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="VCode" ErrorMessage="Please enter valid verification code" ForeColor="Red" ValidationExpression="[0-9]{5}">  </asp:RegularExpressionValidator> 
				...
				<div class="u-align-left u-form-group u-form-submit u-form-group-11"><br />
				  ...
				  <asp:Button id="Button2" class="u-form-control-hidden" Text="Submit" OnClick="Submit_Click" runat="server"  />
