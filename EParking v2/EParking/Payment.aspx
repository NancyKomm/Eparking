<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="EParking.Payment" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="BookNow.css" media="screen">
	<script class="u-script" type="text/javascript" src="jquery.js" defer=""></script>
	<script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script>
	<!--<script class="u-script" type="text/javascript" src="MyJavaScript.js" defer=""></script>-->
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-3d90">
	 ...
	 <section style="margin: 0 auto;" class="u-clearfix u-image u-section-2" id="sec-02ff" data-image-width="1600" data-image-height="1067">
		<form id="form1" runat="server" >
		  <div class="u-clearfix u-sheet u-valign-middle-sm u-sheet-1">
			<div class="u-container-style u-group u-white u-group-1">
			  <div class="u-container-layout u-container-layout-1">
				<h2 class="u-align-center u-custom-font u-font-oswald u-text u-text-1">Payment</h2>
				
					 <div class="payment-title"  >
						<h1>Payment Information</h1>
							</div>
							<div style="margin: 0 auto;" class="container preload">
							...
							<div style="margin: 0 auto;" class="form-container">
								<div class="field-container">
									<label for="name">Card Holder's Name</label>
									<!--<input id="name" maxlength="20" type="text">-->
									<asp:TextBox placeholder="Enter your name as it appears on the card" ID="name" class="u-border-1 u-border-grey-75 u-input u-input-rectangle u-white" required runat="server"></asp:TextBox>
									<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="name" ErrorMessage="Please enter valid name" ForeColor="Red" ValidationExpression="(?![\s.]+$)[A-Z]{1,25}[\s.][A-Z]{1,25}">  </asp:RegularExpressionValidator> 

								</div>
								<div class="field-container">
									<label for="cardnumber">Card Number</label><span id="generatecard">generate random</span>
									<!--<input id="cardnumber" type="text" pattern="[0-9]*" inputmode="numeric">-->
									<asp:TextBox placeholder="XXXX XXXX XXXX XXXX" ID="cardnumber" class="u-border-1 u-border-grey-75 u-input u-input-rectangle u-white" required runat="server"></asp:TextBox>
									<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="cardnumber" ErrorMessage="Please enter valid card number" ForeColor="Red" ValidationExpression="[0-9]{4}[\s.][0-9]{4}[\s.][0-9]{4}[\s.][0-9]{4}">  </asp:RegularExpressionValidator>
								...
								<div class="field-container">
									<div class="col-auto mr-2">
										...
										<asp:TextBox type="text" ID="expirationdate"  class="form-control" inputmode="numeric" required runat="server"></asp:TextBox>
										<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="expirationdate" ErrorMessage="Please enter valid date" ForeColor="Red" ValidationExpression="[0-9]{2}/[0-9]{2}">  </asp:RegularExpressionValidator>
								...
								<div class="field-container">
									...
									<asp:TextBox ID="securitycode" class="u-border-1 u-border-grey-75 u-input u-input-rectangle u-white" required runat="server"></asp:TextBox>
									<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="securitycode" ErrorMessage="Please enter valid security code" ForeColor="Red" ValidationExpression="[0-9]{3}">  </asp:RegularExpressionValidator> 
								...
								<div class="u-align-left u-form-group u-form-submit u-form-group-11">
								  ...
								  <asp:Button id="Button2" class="u-border-1 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5" Text="Submit" OnClick="Submit_Click2"  runat="server"  />
