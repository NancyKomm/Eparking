<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="EParking.Admin" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" style="font-size: 16px;">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-3d90">
      <img class="u-image u-image-default u-image-1" src="images/e-parking_logo2.png" alt="" data-image-width="1000" data-image-height="345" data-href="/Administration.aspx" data-page-id="438027"><nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
     ...
     <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="HomePageL.aspx" style="padding: 34px 100px;"></a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Admin.aspx" style="padding: 34px 100px;">Administration</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Admin.aspx" style="padding: 34px 98px;">Administration</a>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-subtitle u-text u-text-3" style="margin-top: 131px; margin-bottom: 0">&nbsp;</h2>
            <div class="u-table u-table-responsive u-table-2" style="left: 313px; top: -401px; height: 165px; width: 756px;">
            <asp:Table ID="UserCarTable" runat="server" class="u-table-entity u-align-center u-grey-10 u-table-alt-grey-5 u-table-body u-table-body-2" Width="727px" >
            
            <asp:TableHeaderRow runat="server" class="u-align-center u-grey-10 u-table-header u-table-header-2" style="height: 84px;">
                    <asp:TableHeaderCell class="u-border-2 u-border-palette-1-light-1 u-palette-2-base u-table-cell u-table-cell-7">Plate-Number</asp:TableHeaderCell>
                    <asp:TableHeaderCell class="u-border-2 u-border-palette-1-light-1 u-palette-2-base u-table-cell u-table-cell-8">Username</asp:TableHeaderCell>
                    <asp:TableHeaderCell class="u-border-2 u-border-palette-1-light-1 u-palette-2-base u-table-cell u-table-cell-8">Delete</asp:TableHeaderCell>
            </asp:TableHeaderRow>
        ...
        <div class="u-table u-table-responsive u-table-2" style="left: 0px; top: 10px; height: auto;">
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Parking Sync"></asp:Label>
          <asp:Table ID="Table1" runat="server" class="u-table-entity u-align-center u-grey-10 u-table-alt-grey-5 u-table-body u-table-body-2">
            
            <asp:TableHeaderRow runat="server" class="u-align-center u-grey-10 u-table-header u-table-header-2" style="height: 84px;">
                 <asp:TableHeaderCell class="u-border-2 u-border-palette-1-light-1 u-palette-2-base u-table-cell u-table-cell-7">Username</asp:TableHeaderCell>
          ...
          <div class="u-table u-table-responsive u-table-2" style="left: 0px; top: 10px; height: auto;">
            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Text="Parking Span"></asp:Label>
          ...
          <div class="u-table u-table-responsive u-table-2" style="left: 0px; top: 10px; height: auto;">
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text="Parking Capsule"></asp:Label>
          <asp:Table ID="Table3" runat="server" class="u-table-entity u-align-center u-grey-10 u-table-alt-grey-5 u-table-body u-table-body-2">
          ...
          <div class="u-table u-table-responsive u-table-2" style="left: 0px; top: 10px; height: auto;">
            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" Text="Hyper Parking"></asp:Label>
          <asp:Table ID="Table4" runat="server" class="u-table-entity u-align-center u-grey-10 u-table-alt-grey-5 u-table-body u-table-body-2">
