             ...
             <div class="u-form-vertical">
              ...
              <form action="#" method="POST" class="u-clearfix  u-inner-form" style="padding: 0;" source="custom" id="form2"  runat="server">
                ...
                <div class="u-form-group u-form-group-8"><br />
                  ...
                  <!--<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="Password" ErrorMessage="Please enter valid password" ForeColor="Red" ValidationExpression="(?=.[a-z])(?=.[A-Z])(?=.\d)(?=.[@$!%?&])[A-Za-z\d@$!%?&]{8,}}">  </asp:RegularExpressionValidator> -->
