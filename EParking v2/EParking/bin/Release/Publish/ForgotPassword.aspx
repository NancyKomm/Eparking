<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="EParking.ForgotPassword" %>
	  ...
	  <div class="u-clearfix u-sheet u-valign-middle-sm u-sheet-1">
		...
		<div class="u-container-style u-group u-white u-group-1" style="left: 284px; top: 22px">
		  <div class="u-container-layout u-container-layout-1">
			<h2 class="u-align-center u-custom-font u-font-oswald u-text u-text-3">Forgot password?
			</h2><br />
			 ...
			 <div class="u-form-vertical">
			  ...
			  <form action="#" method="POST" class="u-clearfix  u-inner-form" style="padding: 0;" source="custom" id="form2"  runat="server">
				...
				<div class="u-form-group u-form-group-4 u-form-spacing-30 u-form-vertical ">
				  <h5><label for="text-47f9" class="u-label u-label-3">Reset password in two quick steps</label></h5><br /><br />
				  <label for="text-47f9" class="u-label u-label-3">Enter your username </label>
				  <asp:TextBox placeholder="Username" ID="Username" name="name1" class="u-border-1 u-border-grey-75 u-input u-input-rectangle u-white" required runat="server" ></asp:TextBox>				
