<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertCar.aspx.cs" Inherits="EParking.InsertCar" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" style="font-size: 16px;">
	...
	<meta property="og:title" content="Insert Car">
	  ...
	  <div class="u-clearfix u-sheet u-valign-middle-sm u-sheet-1">
		...
		<div class="u-container-style u-group u-white u-group-1" style="left: 284px; top: 22px">
		  <div class="u-container-layout u-container-layout-1">
			<h2 class="u-align-center u-custom-font u-font-oswald u-text u-text-3">Insert car
			</h2><br /><br />
			 ...
			 <div class="u-form-vertical">
			  ...
			  <form action="#" method="POST" class="u-clearfix  u-inner-form" style="padding: 0;" source="custom" id="form2"  runat="server">
				...
				<div class="u-align-left u-form-group u-form-submit u-form-group-11"><br />
				  ...
				  <asp:Button id="Insert_Car" class="u-border-1 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5" Text="Insert Car" OnClick="Insert_Car_Click" runat="server"  />
				  <!--<input type="submit" value="submit" class="u-form-control-hidden">-->
				</div>

				<div class="u-align-left u-form-group u-form-submit u-form-group-11"><br />
				  <!--<a href="#" class="u-border-1 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5">Go to Profile</a>-->
				  <asp:Button id="Done" class="u-border-1 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5" Text="Done" OnClick="Done_Click" runat="server"  />
				  <!--<input type="submit" value="submit" class="u-form-control-hidden">-->
				</div>
