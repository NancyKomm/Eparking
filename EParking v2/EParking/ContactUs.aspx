<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="EParking.ContactUs" %>
				...
				<div class="u-container-layout u-container-layout-1">
				  ...
				  <h4 class="u-text u-text-2">Customer Support Phone Service: 210 4142000<br>
					<br>Working Hours<br>&nbsp; &nbsp; Monday - Friday: 09:00 AM to 11:00 PM<br>&nbsp; &nbsp; Saturday - Sunday: 10:00 AM to 07:00 PM<br> <br> Are you a parking owner? If you would like to become a member, please contact us.
                      <br> <br> Got any questions? Check our FAQ page: <a href="FAQ.html" style="color:dodgerblue" onmouseover="this.style.color='cornflowerblue';" onmouseout="this.style.color='dodgerblue';"><p class="u-text u-text-variant u-text-3">Frequently Asked Questions </p></a>
				</div>
			  </div>
