<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParkingsL.aspx.cs" Inherits="EParking.ParkingsL" %>
          ...
          <div class="u-carousel-inner" role="listbox">
            <div class="u-active u-align-left u-carousel-item u-container-style u-slide">
              <div class="u-container-layout u-container-layout-1">
                ...
                <p class="u-text u-text-2">Provides parking spots for electric vehicles (charging stations), motorcycles, disabled and conventional cars.<br>Gated, Underground, Security cameras, High ceiling.<br>
                  <span style="font-weight: 700;">Karaoli ke Dimitriou 80, Piraeus</span>
                </p>
                <a href="BookNow.aspx" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">Book now</a>
            ...
            <div class="u-align-left u-carousel-item u-container-style u-slide">
              <div class="u-container-layout u-container-layout-2">
                ...
                <p class="u-text u-text-4">Provides parking spots for electric vehicles (charging stations), motorcycles, disabled and conventional cars.<br>Gated, Underground, Security cameras, High ceiling.<br>
                  <span style="font-weight: 700;">Road Eirinis 65 - 67, Perama</span>
                </p>
                <a href="BookNow.aspx" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-2">Book now</a>
              </div>
            </div>
            <div class="u-carousel-item u-container-style u-slide">
              <div class="u-container-layout u-container-layout-3">
                ...
                <p class="u-text u-text-6">Provides parking spots for motorcycles, disabled and conventional cars.<br>Guarded, Security cameras, High ceiling.<br>
                  <span style="font-weight: 700;">Dimitros 26, Elefsina</span>
                </p>
                <a href="BookNow.aspx" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-3">Book now</a>
            ...
            <div class="u-carousel-item u-container-style u-slide">
              <div class="u-container-layout u-container-layout-4">
                ...
                <p class="u-text u-text-8">Provides parking spots for motorcycles, disabled and conventional cars.<br>Guarded, Security cameras, Low ceiling.<br><b>Minoas 15, Megara</b>
                </p>
                <a href="BookNow.aspx" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-4">Book now</a>
